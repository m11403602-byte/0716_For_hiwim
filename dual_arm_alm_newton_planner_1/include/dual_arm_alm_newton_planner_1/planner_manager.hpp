...
public:
  ...
  // [NEW] ALM 參數 (預設 = Newton 建議值)
  double alm_mu0_ = 10.0; double alm_c0_ = 5.0; double alm_c_max_ = 100.0;
...
private:
  ...
  mutable double alm_mu0_ = 10.0; mutable double alm_c0_ = 5.0; mutable double alm_c_max_ = 100.0;
