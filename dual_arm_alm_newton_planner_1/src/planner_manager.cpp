...
// =====================================================================
#include "dual_arm_alm_newton_planner_1/planner_manager.hpp"
...
void DualArmAlmNewtonPlannerManager::load_parameters() const
{
  ...
  node_->get_parameter_or(ns + "alm_c_max",           alm_c_max_,           100.0);
...
PLUGINLIB_EXPORT_CLASS(
    dual_arm_alm_newton_planner_1::DualArmAlmNewtonPlannerManager,
