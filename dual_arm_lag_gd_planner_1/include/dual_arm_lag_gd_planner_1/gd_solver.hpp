// =====================================================================
// gd_solver.hpp — 第 1 層: 純 Lagrangian 內層優化器 (梯度下降)
//   = MATLAB Dual_Arm_Lagrangian_Gradient_v2
// =====================================================================
//   純 Lagrangian (S²-slack) + 梯度下降 (Steepest Descent) + 1D Newton 線搜索
//   ⚠ 與 ALM 譜系「不同的數學物件」:
...
// =====================================================================
#ifndef DUAL_ARM_LAG_GD_PLANNER_1_GD_SOLVER_HPP
#define DUAL_ARM_LAG_GD_PLANNER_1_GD_SOLVER_HPP
...
#endif  // DUAL_ARM_LAG_GD_PLANNER_1_GD_SOLVER_HPP
