...
//   solver 數學層 (L / G / line_search / run_newton) 照 Gradient_v2 移植。
// =====================================================================
#include "dual_arm_lag_gd_planner_1/gd_solver.hpp"
...
// =====================================================================
// run_newton: 主迴圈 (GD 最陡下降 + 1D Newton 線搜索)
//   = MATLAB Dual_Arm_Lagrangian_Gradient_v2.run_newton
// =====================================================================
SolverLog GdSolver::run_newton()
{
  SolverLog log;
