...
// =====================================================================
#include "dual_arm_lag_newton_planner_1/planner_manager.hpp"
...
void DualArmLagNewtonPlannerManager::load_parameters() const
{
  ...
  node_->get_parameter_or(ns + "smooth_w",            smooth_w_,            1.0);
  ...
  node_->get_parameter_or(ns + "lag_wd",              lag_wd_,              1.0);               // [NEW] 純 Lagrangian 六參數
  node_->get_parameter_or(ns + "lag_lam0",            lag_lam0_,            30.0);
  node_->get_parameter_or(ns + "lag_s0",              lag_s0_,              1.0);
  node_->get_parameter_or(ns + "lag_tol_phys_margin", lag_tol_phys_,        0.01);
  node_->get_parameter_or(ns + "lag_tol_stable",      lag_tol_stable_,      0.005);
  node_->get_parameter_or(ns + "lag_tol_stat",        lag_tol_stat_,        0.1);
...
PLUGINLIB_EXPORT_CLASS(
    dual_arm_lag_newton_planner_1::DualArmLagNewtonPlannerManager,
