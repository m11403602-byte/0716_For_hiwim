...
//   solver 數學層 (L / G / compute_H / run_newton) 照 Newton_v2 移植。
// =====================================================================
#include "dual_arm_lag_newton_planner_1/newton_solver.hpp"
...
// =====================================================================
// run_newton: 主迴圈 (全維度 Newton: d=-H\G LDLT, α=1 純步)
//   = MATLAB Dual_Arm_Lagrangian_Newton_v2.run_newton
// =====================================================================
SolverLog NewtonSolver::run_newton()
{
  SolverLog log;
