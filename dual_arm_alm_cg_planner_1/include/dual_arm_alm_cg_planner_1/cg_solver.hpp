// =====================================================================
// cg_solver.hpp — 第 1 層: 內層 CG 優化器 (= MATLAB Dual_Arm_Inequality_ALM_CG_v7)
// =====================================================================
//   ALM (PHR) 外層 + CG-FR (Fletcher-Reeves 共軛梯度) 內層 + 1D Newton 線搜索
//   ⚠ CG 版「無 Hessian、無 LDLT」: 方向 d = -G + beta*pre_d, 步長靠線搜索
//   數學模型與 CG_v7 / Newton_v6 完全相同 (僅內層求解方法為 CG)
//
//   [MATLAB] 對應 class: Dual_Arm_Inequality_ALM_CG_v7
//   座標/單位: 全 degree (與 MATLAB 一致); 距離 mm
//   FK 4x4 用 Eigen::Matrix4d (固定尺寸); 涉 num_D 的矩陣用動態尺寸
// =====================================================================
#ifndef DUAL_ARM_AVOIDANCE_PLANNER_1_CG_SOLVER_HPP
#define DUAL_ARM_AVOIDANCE_PLANNER_1_CG_SOLVER_HPP
...
struct SolverLog {
  ...
  std::vector<double> alpha_history;     // CG 線搜索步長
...
{
public:
  // [MATLAB] 建構函數 Dual_Arm_Inequality_ALM_CG_v7(X, robotA_base, robot_base, DANGER_THRESHOLD, path_weight)
...
#endif  // DUAL_ARM_AVOIDANCE_PLANNER_1_CG_SOLVER_HPP
